...
LINK_ENTITY_TO_CLASS( info_displacer_earthdeastination, CPointEntity )
...
LINK_ENTITY_TO_CLASS( displacer_teleporter, CDisplacerBall )
...
void CDisplacer::Teleport( void )
{
	...
	{
		pTarget = UTIL_FindEntityByClassname( 0, "info_displacer_xen_target" );
	}
